			...
			<main className="flex min-h-screen flex-col lg:flex-row">
				<div className="flex flex-1 flex-col justify-center border-black p-8 lg:border-r-4 lg:p-24 dark:border-white">
					...
					<p className="mt-8 max-w-md font-bold font-sans text-xl uppercase tracking-widest opacity-60">
						Establish your presence. Begin the record of all things owed.
					</p>
				</div>
					...
					<div className="brutal-shadow w-full max-w-md border-4 border-black bg-white p-10 dark:border-white dark:bg-black">
						...
						<form className="space-y-8" onSubmit={handleSubmit}>
							<div>
								...
								<div className="relative">
									<input
										...
										value={name}
									/>
									<User className="absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 opacity-40" />
								</div>
							</div>
							...
							<div>
								...
								<div className="relative">
									<input
										...
										value={email}
									/>
									<Mail className="absolute top-1/2 left-4 h-5 w-5 -translate-y-1/2 opacity-40" />
								</div>
							</div>
							...
							<button
								...
								type="submit"
							>
								{isLoading ? "Enrolling..." : "Begin Record"}
							</button>
						</form>
